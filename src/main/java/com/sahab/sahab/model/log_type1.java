...
public class log_type1 extends Log {


    public log_type1(String type, String event, String thread, String info, String year, String month, String day, String hour, String minute, String second, String appName, String msg) {
